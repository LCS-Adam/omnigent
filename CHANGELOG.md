...
- [UI / Bug fix] [UI] Confirming a Japanese IME conversion with Enter no longer submits the session rename or new-project name inputs (#2459)
...
- [UI / Feature] - [UI / Feature] Added a Nord color theme (arctic frost-blue palette) to the Appearance settings palette picker. (#2561)
...
- [Bug fix] Claude-native messages that fail to reach Claude (or stall unsent in the (#2591)
...
- [UI] [UI] Sidebar rows, section headers, and nav items now line up on a consistent grid (#2596)
...
- [Chore / Breaking] `omnigent[memory]` is renamed to `omnigent[hindsight]`; the Hindsight memory (#2605)
...
- [Bug fix / Test/CI] N/A — internal test stability fix. (#2620)
...
- [Feature] This pull request and its description were written by Isaac. (#2682)
...
- [UI / Chore] N/A — internal refactor with no user-facing behavior change. (#2728)
...
- [UI] Changed: the Gateway option in model setup no longer cites OpenRouter as an example — use the dedicated OpenRouter option instead (#2738)
...
- [Docs] DELETE THIS WHOLE SECTION (#2769)
...
- [Chore] This pull request and its description were written by Isaac. (#2782)
- [Bug fix] This pull request and its description were written by Isaac. (#2786)
...
- [Bug fix] This pull request and its description were written by Isaac. (#2791)
- [Feature] This pull request and its description were written by Isaac. (#2792)
- [Bug fix] This pull request and its description were written by Isaac. (#2794)
...
- [Feature] This pull request and its description were written by Isaac. (#2797)
- [Bug fix] This pull request and its description were written by Isaac. (#2798)
...
- [Feature] This pull request and its description were written by Isaac. (#2804)
...
- [Chore] N/A — repository cleanup only. (#2844)
...
- [Bug fix] Fixed `/model show` (and `list`/`status`/`current`) bricking the session: these (#2888)
- [Bug fix] Clicking "Stop session" no longer shows a spurious "runner disconnected" error (#2903)
- [Chore] DELETE THIS WHOLE SECTION — internal perf/refactor, no user-facing change. (#2905)
- [UI / Bug fix] New-session Send button shows a spinner while the session is being created, instead of looking frozen (#2907)
- [Feature] This pull request and its description were written by Isaac. (#2908)
- [Feature] This pull request and its description were written by Isaac. (#2911)
- [Feature / Breaking] [Feature] Per-harness startup command/args overrides via a polymorphic `harness:` config key + `OMNIGENT_<NAME>_PATH` env-var standardization (legacy `HARNESS_*_PATH` deprecated, slated for v0.8.0 removal) (#2933)
